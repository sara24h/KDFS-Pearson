...
    # این تابع را در کلاس Test در فایل main.py خود جایگزین کنید

def dataload(self):
    print("==> Loading datasets...")
    
    # تعریف تبدیلات ثابت بر اساس آمار دیتاست 140k
    image_size = (256, 256)
    ...
    # ### بخش کلیدی ###
    # اضافه کردن منطق آدرس‌دهی برای تمام دیتاست‌ها
    ...
    # بازنویسی transformها برای استفاده از آمار یکسان 140k
